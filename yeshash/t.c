...
// SHA_DIGEST_LENGTH*2 p/ evitar estouro de pilha ("smashing stack detected")
 ...
 //preenchendo, inicializabdo transf e calc
    ...
    //strlen retorna o numero de caracteres da string
    //sizeof retorna o numero de bytes da string completa	
